...
if (!$err || $err == null) {
    $create = $conn->prepare("INSERT INTO quakechampions ( uuid, player1, player2, `password`, bestof, champ_mode ) VALUES ( ?, ?, ?, ?, ?, ? )");
    $create->execute(array($_SESSION['unique'], $_POST['player1'], $_POST['player2'], md5($_POST['pwd']), $_POST['bestof'], $_POST['champ_mode']));
